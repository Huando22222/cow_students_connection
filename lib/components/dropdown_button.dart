...
class DropdownButtonCustom extends StatefulWidget {
  final List<String> items; // Thêm thuộc tính để chứa danh sách
    ...
    return Center(
      child: DropdownButtonHideUnderline(
        child: DropdownButton2<String>(
          ...
          items: widget.items // Sử dụng danh sách từ thuộc tính widget
          ...
          onChanged: (value) {
            setState(() {
              selectedValue = value;
              // context.read<AppRepo>().setGender = value;
